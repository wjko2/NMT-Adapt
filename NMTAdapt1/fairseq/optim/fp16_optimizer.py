...
class _FP16OptimizerMixin(object):
    ...
    def backward2(self, loss,retain_graph=False,scaler=0):
        """Computes the sum of gradients of the given tensor w.r.t. graph leaves.
        ...
        underflow.
        """
        if not type(scaler)==int and scaler is not None:
            self.scaler=scaler
        if self.scaler is not None:
            loss = self.scaler.scale(loss)
        loss.backward(retain_graph=retain_graph)
...
class FP16Optimizer(_FP16OptimizerMixin, optim.FairseqOptimizer):
    ...
    @classmethod
    def build_optimizer(cls, args, params,params1,params2):
        """
        Args:
        ...
        fp32_params1 = cls.build_fp32_params(args, params1, flatten=flatten)
        fp32_params2 = cls.build_fp32_params(args, params2, flatten=flatten)
        if flatten:
            fp32_optimizer = optim.build_optimizer(args, [fp32_params])
            arggs=copy.deepcopy(args)
            arggs.optimizer='sgd'
            fp32_optimizer1 = optim.build_optimizer(arggs, [fp32_params1])
            fp32_optimizer2 = optim.build_optimizer(arggs, [fp32_params2])
        else:
            fp32_optimizer = optim.build_optimizer(args, fp32_params)
        ...
        return cls(args, params, fp32_optimizer, fp32_params),cls(arggs, params1, fp32_optimizer1, fp32_params1),cls(arggs, params2, fp32_optimizer2, fp32_params2)
...
class MemoryEfficientFP16Optimizer(_MemoryEfficientFP16OptimizerMixin, optim.FairseqOptimizer):
    ...
    *supports_memory_efficient_fp16* property.
    ...
    def build_optimizer(cls, args, params,params1,params2):
        ...
        arggs=copy.deepcopy(args)
        fp16_optimizer1 = optim.build_optimizer(arggs, params1)
        fp16_optimizer2 = optim.build_optimizer(arggs, params2)
        return cls(args, params, fp16_optimizer),cls(args, params1, fp16_optimizer1),cls(args, params2, fp16_optimizer2)
